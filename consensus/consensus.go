...
type Engine interface {
	...
	Finalize(chain ChainHeaderReader, header *types.Header, state *state.StateDB, txs *[]*types.Transaction,
		uncles []*types.Header, withdrawals []*types.Withdrawal, receipts *[]*types.Receipt, systemTxs []*types.Transaction) error
...
type PoSA interface {
	...
	CanCreate(state StateReader, addr common.Address, height *uint256.Int) bool
